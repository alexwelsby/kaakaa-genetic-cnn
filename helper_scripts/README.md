...
- embeddings_faiss: contains scripts for accessing embeddings and evaluating k-NN cosine similarity accuracy of vector embeddings using FAISS for CNN and DINOv2.
